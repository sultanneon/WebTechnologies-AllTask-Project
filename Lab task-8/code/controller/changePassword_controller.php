...
if(isset($_POST['submit']) && isset($_SESSION['username']))
{
 ...
 if(empty($_POST["npassword"]))
 {
   ...
   {
     $_SESSION['npasswordE']= "Password can't be less than eight characters";
     $flag=0;
   }
   else {
 ...
 if(empty($_POST["rnpassword"]))
 {
   ...
   {
      $_SESSION['rnpasswordE']="Retype new password must be more than seven characters";
     $flag=0;
   }
   else {
      ...
      if($data!=NULL)
      {
        ...
        if($cpassword==$passwordFromDB)
        {
          ...
          if (updatePassword($_SESSION['username'], $npassword)) {
		   ...
		   header('Location: ../changePassword_view.php');
        }
        }
        else {
  ...
  else{header('Location: ../changePassword_view.php');}
}
