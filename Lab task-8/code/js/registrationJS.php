	...
	<script type="text/javascript">  
        ...
        function checkConfirmpassword()
        {
        	...
        	{
			  	document.getElementById("confirmpasswordErr").innerHTML = "Confirm password can't be empty";
			...
			else if(document.getElementById("confirmpassword").value !== document.getElementById("password").value)
			{
			  	document.getElementById("confirmpassword").style.borderColor = "red";
			  	document.getElementById("confirmpasswordErr").style.color = "red";
				document.getElementById("confirmpasswordErr").innerHTML = "Password & Confirm password can't be different";
			}
			else{
			  	document.getElementById("confirmpasswordErr").style.color = "red";
