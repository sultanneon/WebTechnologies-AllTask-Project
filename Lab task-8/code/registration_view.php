...
<head>
	...
	<?php require_once 'js/registrationJS.php'; ?>
	<style type="text/css">
	</style>
</head>
  		...
  		<div class="row" align="center" >
    		<div class="col-12" >
				<div class="card" style="width: 20rem; border-width: 5px;" align="center " >
					 ...
					 <form action="controller/registration_controller.php" method="POST" enctype="multipart/form-data" onsubmit="validateform()">

    					<h4 style="color:#201772" class="card-title"><b>SIGN UP</b></h4>
    					<b>Name:</b>
						...
						<br> <span id="usernameErr" >* <?php echo $_SESSION['usernameErr'];?></span><br>
						<br>
